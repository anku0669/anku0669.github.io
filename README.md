# Ankush Bhadwar — Cybersecurity Portfolio

<div align="center">

### 🌐 **[anku0669.github.io](https://anku0669.github.io)**
...
### ✨ Features
- 🎨 Full glassmorphism dark hacker UI with Matrix rain
- 🤖 **60+ AI jailbreak prompts embedded** — no external redirects
- 📊 All 4 techniques: Manipulation Matrix, Component Fragmentation, Crescendo, Cognitive Dissonance
- 💼 LinkedIn · GitHub · TryHackMe · unjail.ai
- 📱 Fully responsive | Custom cursor | Scroll reveal

### 🛠 Security Toolkit
`Nmap` `Metasploit` `Burp Suite` `Wireshark` `Hydra` `Python` `Kali Linux`
